...
-- Proposito: Banco de dados para sistema de gestao de clínica veterinaria
...
-- Cria um role específico para o banco de dados (substitua 'vetmed_user' e 'senha_segura' conforme necessario)
DO $$
BEGIN
    IF NOT EXISTS (SELECT FROM pg_catalog.pg_roles WHERE rolname = 'vetmed_user') THEN
        CREATE ROLE vetmed_user WITH LOGIN PASSWORD 'senha_segura';
    END IF;
END $$;

GRANT ALL PRIVILEGES ON DATABASE VetMed TO vetmed_user;
...
CREATE TABLE IF NOT EXISTS Veterinario (
    id_veterinario CHAR(11) PRIMARY KEY,  -- CPF do veterinario
    nome VARCHAR(90) NOT NULL,
    telefone VARCHAR(20) NOT NULL,
    endereco VARCHAR(120) NOT NULL,
